...
import { AiOutlineLike, AiOutlineDislike, AiOutlinePlus,AiOutlineCheck } from "react-icons/ai";
...
const YoutubeWatchVideoContainer = () => {
  return (
    <>
      <div className="videocontainer flex w-[60%] flex-col -z-10 gap-2 p-2 border border-white border-opacity-10 rounded-md ">
        <div>
          <video controls width={750} height={250} />
          <source src="movie.mp4" type="video/mp4" />
        </div>
        <div className="titlecotainer text-lg w-full px-2">
          <h1 className="boldfontstyle font-bold">
            Hello , This is My Sad Story
          </h1>
        </div>
